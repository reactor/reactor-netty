...
public class NettyOperations<INBOUND extends NettyInbound, OUTBOUND extends NettyOutbound>
	...
	public static NettyState state(Channel ch) {
	...
	public void onActive(ChannelHandlerContext ctx) {
		handler.apply((INBOUND) this, (OUTBOUND) this)
		       .subscribe(new NettyOperations.CloseSubscriber(ctx));
	 ...
	 * @author Stephane Maldini
	 */
	static final class FlushOnEachSubscriber
	...
	static final class FlushOnTerminateSubscriber
