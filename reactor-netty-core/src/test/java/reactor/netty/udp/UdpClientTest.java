...
class UdpClientTest {
	...
	void testIssue192() throws Exception {
		testIssue192(new NioEventLoopGroup(1));
	}

	@Test
	void testIssue192OnNetty42() throws Exception {
		testIssue192(new MultiThreadIoEventLoopGroup(1, NioIoHandler.newFactory()));
	}

	private void testIssue192(EventLoopGroup loop) throws Exception {
