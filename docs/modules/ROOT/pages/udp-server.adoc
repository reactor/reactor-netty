...
:examples-dir: {examples}/src/main/java/reactor/netty5/examples/documentation/udp/server
:javadoc: https://projectreactor.io/docs/netty/{project-version}/api
:nettyjavadoc: https://netty.io/5.0/api
:wirelogger: reactor.netty5.udp.UdpServer

[[udp-server]]
= UDP Server

Reactor Netty provides the easy-to-use and easy-to-configure
{javadoc}/reactor/netty5/udp/UdpServer.html[`UdpServer`].
...
To start a UDP server, a {javadoc}/reactor/netty5/udp/UdpServer.html[UdpServer]
...
----
<1> Creates a {javadoc}/reactor/netty5/udp/UdpServer.html[`UdpServer`]
...
* xref:udp-server.adoc#server-udp-connection-configurations-wire-logger[null]
* xref:udp-server.adoc#server-udp-connection-configurations-event-loop-group[null]
...
[source,java,indent=0]
.{sourcedir}/reactor/netty5/udp/UdpServerBind.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty5/udp/UdpServerBind.java[lines=40..44]
----
...
It exposes all metrics with a prefix of `reactor.netty5.udp.server`.
...
| reactor.netty5.udp.server.data.received | DistributionSummary | Amount of the data received, in bytes.
See xref:observability.adoc#observability-metrics-data-received[]
| reactor.netty5.udp.server.data.sent | DistributionSummary | Amount of the data sent, in bytes.
See xref:observability.adoc#observability-metrics-data-sent[]
| reactor.netty5.udp.server.errors | Counter | Number of errors that occurred.
...
----
<1> Enables UDP server metrics and provides {javadoc}/reactor/netty5/channel/ChannelMetricsRecorder.html[`ChannelMetricsRecorder`] implementation.
