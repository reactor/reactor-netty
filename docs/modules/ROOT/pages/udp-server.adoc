...
:examples-link: {reactor-netty-github-repo}/reactor-netty5-examples/src/main/java/reactor/netty5/examples/documentation/udp/server
...
{core-source-link}/reactor/netty5/udp/UdpServerBind.java
[%unbreakable]
----
