...
[%unbreakable]
----
include::{examples-dir}/send/connection/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/read/connection/Application.java[tags=snippet-application]
----
<1> Receives data from a given endpoint.
...
----
include::{sourcedir}/reactor/netty/tcp/TcpClientConnect.java[tags=snippet-code]
----
