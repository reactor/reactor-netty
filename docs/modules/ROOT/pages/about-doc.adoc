...
sources at https://github.com/reactor/reactor-netty/tree/netty5/docs.
...
link:https://github.com/reactor/reactor-netty/edit/netty5/docs/modules/ROOT/pages/about-doc.adoc[Suggest Edit^, role="fa fa-edit"] to xref:about-doc.adoc[About the Documentation].
endif::[]
...
https://github.com/reactor/reactor-netty/tree/netty5/docs/asciidoc[including this
documentation].
