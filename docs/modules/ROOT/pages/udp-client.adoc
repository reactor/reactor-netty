...
:examples-link: {reactor-netty-github-repo}/reactor-netty5-examples/src/main/java/reactor/netty5/examples/documentation/udp/client
...
{core-source-link}/reactor/netty5/udp/UdpClientConnect.java
[%unbreakable]
----
