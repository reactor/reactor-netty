...
:examples-dir: {examples}/src/main/java/reactor/netty5/examples/documentation/udp/client
:javadoc: https://projectreactor.io/docs/netty/{project-version}/api
:nettyjavadoc: https://netty.io/5.0/api
:wirelogger: reactor.netty5.udp.UdpClient

[[udp-client]]
= UDP Client

Reactor Netty provides the easy-to-use and easy-to-configure
{javadoc}/reactor/netty5/udp/UdpClient.html[`UdpClient`].
...
{javadoc}/reactor/netty5/udp/UdpClient.html[UdpClient] instance.
...
----
<1> Creates a {javadoc}/reactor/netty5/udp/UdpClient.html[`UdpClient`]
...
The I/O handler has access to {javadoc}/reactor/netty5/udp/UdpOutbound.html[`UdpOutbound`],
...
The I/O handler has access to {javadoc}/reactor/netty5/udp/UdpInbound.html[`UdpInbound`],
...
[source,java,indent=0]
.{sourcedir}/reactor/netty5/udp/UdpClientConnect.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty5/udp/UdpClientConnect.java[lines=37..42]
----
...
It exposes all metrics with a prefix of `reactor.netty5.udp.client`.
...
| reactor.netty5.udp.client.data.received | DistributionSummary | Amount of the data received, in bytes.
See xref:observability.adoc#observability-metrics-data-received[]
| reactor.netty5.udp.client.data.sent | DistributionSummary | Amount of the data sent, in bytes.
See xref:observability.adoc#observability-metrics-data-sent[]
| reactor.netty5.udp.client.errors | Counter | Number of errors that occurred.
See xref:observability.adoc#observability-metrics-errors-count[]
| reactor.netty5.udp.client.connect.time | Timer | Time spent for connecting to the remote address.
See xref:observability.adoc#observability-metrics-connect-time[]
| reactor.netty5.udp.client.address.resolver | Timer | Time spent for resolving the address.
...
----
<1> Enables UDP client metrics and provides {javadoc}/reactor/netty5/channel/ChannelMetricsRecorder.html[`ChannelMetricsRecorder`] implementation.
