...
:examples-dir: {examples}/src/main/java/reactor/netty5/examples/documentation/tcp/server
:javadoc: https://projectreactor.io/docs/netty/{project-version}/api
:nettyjavadoc: https://netty.io/5.0/api
:wirelogger: reactor.netty5.tcp.TcpServer
:stylesheet: stylesheets/reactor.css

[[tcp-server]]
= TCP Server

`Reactor Netty` provides an easy to use and configure
{javadoc}/reactor/netty5/tcp/TcpServer.html[`TcpServer`].
...
{javadoc}/reactor/netty5/tcp/TcpServer.html[`TcpServer`] instance.
...
----
<1> Creates a {javadoc}/reactor/netty5/tcp/TcpServer.html[`TcpServer`]
...
[source,java,indent=0, class="no-page-break"]
...
[source,java,indent=0]
.{sourcedir}/reactor/netty5/tcp/TcpServerBind.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty5/tcp/TcpServerBind.java[lines=37..45]
----
...
It exposes all metrics with a prefix of `reactor.netty5.tcp.server`.
...
| reactor.netty5.tcp.server.connections.total | Gauge | The number of all opened connections.
See xref:observability.adoc#observability-metrics-connections-total[]
| reactor.netty5.tcp.server.data.received | DistributionSummary | Amount of the data received, in bytes.
See xref:observability.adoc#observability-metrics-data-received[]
| reactor.netty5.tcp.server.data.sent | DistributionSummary | Amount of the data sent, in bytes.
See xref:observability.adoc#observability-metrics-data-sent[]
| reactor.netty5.tcp.server.errors | Counter | Number of errors that occurred.
See xref:observability.adoc#observability-metrics-errors-count[]
| reactor.netty5.tcp.server.tls.handshake.time | Timer | Time spent for TLS handshake.
