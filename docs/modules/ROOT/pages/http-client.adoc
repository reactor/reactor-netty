...
[%unbreakable]
----
include::{examples-dir}/connect/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/websocket/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/address/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/warmup/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/send/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/send/headers/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/compression/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/redirect/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/read/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/read/status/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{sourcedir}/reactor/netty/http/HttpDecoderSpec.java[tags=snippet-code]
----

{http-source-link}/reactor/netty/http/client/HttpResponseDecoderSpec.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty/http/client/HttpResponseDecoderSpec.java[tags=snippet-code]
----
...
[%unbreakable]
----
include::{examples-dir}/responsedecoder/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/lifecycle/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/channeloptions/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/security/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/sni/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/http2/H2Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/http2/H2CApplication.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{sourcedir}/reactor/netty/http/HttpProtocol.java[tags=snippet-code]
----
...
----
include::{examples-dir}/http3/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/metrics/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/metrics/custom/Application.java[tags=snippet-application]
----
...
[[websocket-metrics]]
=== WebSocket Metrics
When the connection is upgraded to a `WebSocket`, the HTTP client metrics handler is replaced by a dedicated
`WebSocket` client metrics handler. From that point on, the metrics are exposed with a prefix of
`reactor.netty.websocket.client`.

The following table provides information for the `WebSocket` client metrics:

[width="100%",options="header"]
|=======
| metric name | type | description
| reactor.netty.websocket.client.handshake.time | Timer | Time spent for the `WebSocket` opening handshake.
| reactor.netty.websocket.client.connection.duration | Timer | Time spent for the lifetime of the `WebSocket` connection.
| reactor.netty.websocket.client.data.received | DistributionSummary | Amount of the data received, in bytes. Control frames (Close, Ping, Pong) are excluded.
| reactor.netty.websocket.client.data.sent | DistributionSummary | Amount of the data sent, in bytes. Control frames (Close, Ping, Pong) are excluded.
| reactor.netty.websocket.client.data.received.time | Timer | Time spent in consuming incoming data.
| reactor.netty.websocket.client.data.sent.time | Timer | Time spent in sending outgoing data.
| reactor.netty.websocket.client.errors | Counter | Number of errors that occurred.
|=======

The same recorder customization applies: when an integration with a system other than `Micrometer` is needed,
provide your own {javadoc}/reactor/netty/http/client/WebSocketClientMetricsRecorder.html[`WebSocketClientMetricsRecorder`] implementation.
...
----
include::{examples-dir}/tracing/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/tracing/custom/Application.java[tags=snippet-application]
----
<1> Initializes Brave, Zipkin, and the Observation registry.
<2> Templated URIs are used as an URI tag value when possible.
<3> Enables the built-in integration with Micrometer.
...
----
include::{examples-dir}/uds/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/resolver/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/resolver/custom/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/pool/config/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/read/timeout/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/liveness/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/security/custom/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/proxy/Application.java[tags=snippet-application]
----
...
[[http-authentication]]
== HTTP Authentication
Reactor Netty `HttpClient` provides a mechanism for automatic retry of requests when HTTP authentication is expected,
allowing you to implement custom authentication such as SPNEGO/Negotiate, OAuth, Bearer tokens, or any other HTTP-based authentication scheme.

This mechanism provides two types of APIs for HTTP authentication:
...
[%unbreakable]
----
include::{examples-dir}/authentication/token/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/authentication/basic/Application.java[tags=snippet-application]
----
<1> The predicate checks for `401 Unauthorized` responses to trigger authentication retry.
...
=== Asynchronous Authentication with httpAuthenticationWhen

When credentials need to be fetched asynchronously (e.g., from external token services, databases, or requiring I/O operations),
...
The following example demonstrates how the authentication API can be used with SPNEGO (Kerberos) using Java's GSS-API:

NOTE: This is a simplified example to showcase the API.

{examples-link}/authentication/spnego/Application.java
[%unbreakable]
----
include::{examples-dir}/authentication/spnego/Application.java[tags=snippet-application]
----
...
* By default, authentication is retried once per request. You can configure the maximum count of retry attempts using the `maxRetries` parameter. If authentication fails after all retry attempts are exhausted, the last response (e.g., `401 Unauthorized`) is returned to the caller.
