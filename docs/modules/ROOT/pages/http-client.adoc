...
:examples-link: {reactor-netty-github-repo}/reactor-netty5-examples/src/main/java/reactor/netty5/examples/documentation/http/client
...
{http-source-link}/reactor/netty5/http/HttpDecoderSpec.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty5/http/HttpDecoderSpec.java[lines=28..33]
----

{http-source-link}/reactor/netty5/http/client/HttpResponseDecoderSpec.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty5/http/client/HttpResponseDecoderSpec.java[lines=42..50]
----
...
{http-source-link}/reactor/netty5/http/HttpProtocol.java
[%unbreakable]
----
