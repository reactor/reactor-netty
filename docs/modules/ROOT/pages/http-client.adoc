...
:examples-dir: {examples}/src/main/java/reactor/netty5/examples/documentation/http/client
:javadoc: https://projectreactor.io/docs/netty/{project-version}/api
:nettyjavadoc: https://netty.io/5.0/api
:wirelogger: reactor.netty5.http.client.HttpClient

[[http-client]]
= HTTP Client

Reactor Netty provides the easy-to-use and easy-to-configure
{javadoc}/reactor/netty5/http/client/HttpClient.html[`HttpClient`].
...
.{examples-dir}/connect/Application.java
[%unbreakable]
----
include::{examples-dir}/connect/Application.java[lines=18..30]
----
<1> Creates a {javadoc}/reactor/netty5/http/client/HttpClient.html[HttpClient]
instance ready for configuring.
<2> Specifies that `GET` method will be used.
<3> Specifies the path.
<4> Obtains the response {javadoc}/reactor/netty5/http/client/HttpClientResponse.html[HttpClientResponse]


The following example uses `WebSocket`:

[source,java,indent=0]
.{examples-dir}/websocket/Application.java
[%unbreakable]
----
...
{javadoc}/reactor/netty5/http/client/HttpClient.RequestSender.html#send-org.reactivestreams.Publisher-[`send(Publisher)`] method.
...
[source,java,indent=0]
.{examples-dir}/redirect/Application.java
[%unbreakable]
----
...
{javadoc}/reactor/netty5/http/client/HttpClient.ResponseReceiver.html[`HttpClient.ResponseReceiver`].
...
{javadoc}/reactor/netty5/http/client/HttpClientResponse.html[`HttpClientResponse`].
The following example shows how to do so.

[source,java,indent=0]
.{examples-dir}/read/status/Application.java
[%unbreakable]
----
...
For more information, see {nettyjavadoc}/io.netty5.codec.http/io/netty5/handler/codec/http/HttpResponseDecoder.html[HttpResponseDecoder]
...
----
[source,java,indent=0]
.{sourcedir}/reactor/netty5/http/client/HttpResponseDecoderSpec.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty5/http/client/HttpResponseDecoderSpec.java[lines=44..52]
----

When you need to change these default settings, you can configure the `HTTP` client as follows:

[source,java,indent=0]
.{examples-dir}/responsedecoder/Application.java
[%unbreakable]
----
...
{nettyjavadoc}/io.netty5.handler/io/netty5/handler/ssl/SslProvider.html#JDK[SslProvider.JDK] provider is used
...
It exposes all metrics with a prefix of `reactor.netty5.http.client`.
...
| reactor.netty5.http.client.data.received | DistributionSummary | Amount of the data received, in bytes.
See xref:observability.adoc#observability-metrics-data-received[]
| reactor.netty5.http.client.data.sent | DistributionSummary | Amount of the data sent, in bytes.
See xref:observability.adoc#observability-metrics-data-sent[]
| reactor.netty5.http.client.errors | Counter | Number of errors that occurred.
See xref:observability.adoc#observability-metrics-errors-count[]
| reactor.netty5.http.client.tls.handshake.time | Timer | Time spent for TLS handshake.
See xref:observability.adoc#observability-metrics-tls-handshake-time[]
| reactor.netty5.http.client.connect.time | Timer | Time spent for connecting to the remote address.
See xref:observability.adoc#observability-metrics-connect-time[]
| reactor.netty5.http.client.address.resolver | Timer | Time spent for resolving the address.
See xref:observability.adoc#observability-metrics-hostname-resolution-time[]
| reactor.netty5.http.client.data.received.time | Timer | Time spent in consuming incoming data.
See xref:observability.adoc#observability-metrics-http-client-data-received-time[]
| reactor.netty5.http.client.data.sent.time | Timer | Time spent in sending outgoing data.
See xref:observability.adoc#observability-metrics-http-client-data-sent-time[]
| reactor.netty5.http.client.response.time | Timer | Total time for the request/response
...
|=======
| metric name | type | description
| reactor.netty5.connection.provider.active.streams | Gauge | The number of the active HTTP/2 streams.
See xref:observability.adoc#observability-metrics-active-streams[]
| reactor.netty5.connection.provider.pending.streams | Gauge | The number of requests that are waiting for opening HTTP/2 stream.
...
[source,java,indent=0]
.{examples-dir}/resolver/Application.java
----
...
{nettyjavadoc}/io.netty5.resolver/io/netty5/resolver/AddressResolverGroup.html[`AddressResolverGroup`] of
{nettyjavadoc}/io.netty5.resolver.dns/io/netty5/resolver/dns/DnsNameResolver.html[`DnsNameResolver`] that supports random selection
of destination addresses if multiple are provided by the nameserver.
See {nettyjavadoc}/io.netty5.resolver.dns/io/netty5/resolver/dns/RoundRobinDnsAddressResolverGroup.html[`RoundRobinDnsAddressResolverGroup`].
Default: {nettyjavadoc}/io.netty5.resolver.dns/io/netty5/resolver/dns/DnsAddressResolverGroup.html[`DnsAddressResolverGroup`]
| `runOn` | Performs the communication with the DNS servers on the given
{javadoc}/reactor/netty5/resources/LoopResources.html[`LoopResources`]. By default, the LoopResources
...
[source,java,indent=0]
.{examples-dir}/resolver/custom/Application.java
----
...
{javadoc}/reactor/netty5/resources/ConnectionProvider.ConnectionPoolSpec.html#maxIdleTime-java.time.Duration-[`maxIdleTime`] is not specified.
...
{javadoc}/reactor/netty5/resources/ConnectionProvider.ConnectionPoolSpec.html#maxLifeTime-java.time.Duration-[`maxLifeTime`] is not specified.
...
[source,java,indent=0]
.{examples-dir}/pool/Application.java
----
...
{javadoc}/reactor/netty5/http/client/HttpClient.html#responseTimeout-java.time.Duration-[`responseTimeout`] is not specified.
...
By default, https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/net/StandardSocketOptions.html#SO_KEEPALIVE[`SO_KEEPALIVE`] is not enabled.
...
https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/net/StandardSocketOptions.html#SO_KEEPALIVE[`SO_KEEPALIVE`].
...
{javadoc}/reactor/netty5/transport/ProxyProvider.Builder.html#connectTimeoutMillis-long-[connection establishment timeout].
...
[source,java,indent=0]
.{examples-dir}/proxy/Application.java
----
