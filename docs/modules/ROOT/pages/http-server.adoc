...
:source-link: {reactor-netty-github-repo}/reactor-netty-http/src/main/java
...
{source-link}/reactor/netty/http/HttpDecoderSpec.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty/http/HttpDecoderSpec.java[lines=28..39]
----

{source-link}/reactor/netty/http/server/HttpRequestDecoderSpec.java
[%unbreakable]
----
...
{source-link}/reactor/netty/http/HttpProtocol.java
----
