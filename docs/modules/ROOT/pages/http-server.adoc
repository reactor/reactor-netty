...
You can configure the `HTTP` server to limit the maximum number of concurrent connections.
...
NOTE: This limit applies to the actual network connections (TCP for HTTP/1.1 and HTTP/2, QUIC for HTTP/3).
