...
[%unbreakable]
----
include::{examples-dir}/create/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/address/MultiAddressApplication.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/routing/Application.java[tags=snippet-application]
----
...
{javadoc}/reactor/netty/http/Http2SettingsSpec.Builder.html#connectProtocolEnabled(boolean)[`connectProtocolEnabled(boolean)`].
...
[%unbreakable]
----
include::{examples-dir}/sse/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/staticresources/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/read/headers/Application.java[tags=snippet-application]
----

[[reading-form-or-multipart-data]]
=== Reading Form or Multipart Data

When you receive data from the connected clients, you might want to access `POST` or `QUERY` `form` (`application/x-www-form-urlencoded`) or
...
[%unbreakable]
----
include::{examples-dir}/multipart/Application.java[tags=snippet-application]
----
<1> Receives `POST` or `QUERY` form/multipart data.
...
[%unbreakable]
----
include::{examples-dir}/multipart/custom/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/clientaddress/CustomForwardedHeaderHandlerApplication.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{sourcedir}/reactor/netty/http/server/HttpRequestDecoderSpec.java[tags=snippet-code]
----
...
[%unbreakable]
----
include::{examples-dir}/requestdecoder/Application.java[tags=snippet-application]
----
...
You can configure the `HttpServer` to limit the maximum number of concurrent connections.
When the limit is reached, new connections are immediately rejected by closing them.
By default, there is no limit (value of `-1`).

The following example configures the server to accept a maximum of 100 concurrent connections:
...
----
<1> Configures the maximum number of concurrent connections to 100.

NOTE: This limit applies to the actual network connections (TCP for HTTP/1.1 and HTTP/2).
HTTP/2 streams over the same connection are not counted separately.

IMPORTANT: This feature is *not supported for HTTP/3*. Attempting to use `maxConnections` with HTTP/3 protocol will result in an `UnsupportedOperationException` when the server attempts to bind.
...
----
include::{examples-dir}/accessLog/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/accessLog/CustomLogAccessFormatApplication.java[tags=snippet-application]
----
...
----
include::{examples-dir}/accessLog/FilterLogAccessApplication.java[tags=snippet-application]
----
...
----
include::{examples-dir}/accessLog/CustomFormatAndFilterAccessLogApplication.java[tags=snippet-application]
----
...
----
include::{examples-dir}/errorLog/Application.java[tags=snippet-application]
----
...
----
include::{examples-dir}/errorLog/CustomLogErrorFormatApplication.java[tags=snippet-application]
----
...
----
include::{examples-dir}/errorLog/FilterLogErrorApplication.java[tags=snippet-application]
----
...
----
include::{examples-dir}/errorLog/CustomFormatAndFilterErrorLogApplication.java[tags=snippet-application]
----
<1> Specifies the filter predicate to use
<2> Specifies the custom format to apply
...
----
include::{examples-dir}/idle/timeout/Application.java[tags=snippet-application]
----
