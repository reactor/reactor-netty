...
:examples-link: {reactor-netty-github-repo}/reactor-netty5-examples/src/main/java/reactor/netty5/examples/documentation/http/server
...
{http-source-link}/reactor/netty5/http/server/HttpRequestDecoderSpec.java
[%unbreakable]
----
