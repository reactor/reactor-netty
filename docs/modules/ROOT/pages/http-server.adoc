...
:examples-dir: {examples}/src/main/java/reactor/netty5/examples/documentation/http/server
...
{javadoc}/reactor/netty5/http/server/HttpServer.html[`HttpServer`] class.
...
{javadoc}/reactor/netty5/http/server/HttpServer.html[HttpServer] instance.
...
.{examples-dir}/create/Application.java
[%unbreakable]
----
include::{examples-dir}/create/Application.java[lines=18..31]
----
<1> Creates an {javadoc}/reactor/netty5/http/server/HttpServer.html[HttpServer]
instance ready for configuring.
<2> Starts the server in a blocking fashion and waits for it to finish initializing.

The returned {javadoc}/reactor/netty5/DisposableServer.html[`DisposableServer`]
offers a simple server API, including {javadoc}/reactor/netty5/DisposableChannel.html#disposeNow-java.time.Duration-[`disposeNow()`],
...
[source,java,indent=0]
.{examples-dir}/address/Application.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/address/MultiAddressApplication.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/warmup/Application.java
[%unbreakable]
----
...
{javadoc}/reactor/netty5/http/server/HttpServerRoutes.html[`HttpServerRoutes`] builder.
The following example shows how to do so:

[source,java,indent=0]
.{examples-dir}/routing/Application.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/sse/Application.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/staticresources/Application.java
[%unbreakable]
----
...
{javadoc}/reactor/netty5/http/server/HttpServer.html#handle-java.util.function.BiFunction-[`handle(...)`] or
{javadoc}/reactor/netty5/http/server/HttpServer.html#route-java.util.function.Consumer-[`route(...)`].
The I/O handler has access to {javadoc}/reactor/netty5/http/server/HttpServerResponse.html[`HttpServerResponse`],
to be able to write data. The following example uses the `handle(...)` method:

[source,java,indent=0]
.{examples-dir}/send/Application.java
[%unbreakable]
----
...
{javadoc}/reactor/netty5/http/server/HttpServerResponse.html[`HttpServerResponse`].
The following example shows how to do so:

[source,java,indent=0]
.{examples-dir}/send/headers/Application.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/compression/Application.java
[%unbreakable]
----
...
{javadoc}/reactor/netty5/http/server/HttpServer.html#handle-java.util.function.BiFunction-[`handle(...)`] or
{javadoc}/reactor/netty5/http/server/HttpServer.html#route-java.util.function.Consumer-[`route(...)`].
The I/O handler has access to {javadoc}/reactor/netty5/http/server/HttpServerRequest.html[`HttpServerRequest`],
to be able to read data.

The following example uses the `handle(...)` method:

[source,java,indent=0]
.{examples-dir}/read/Application.java
[%unbreakable]
----
...
{javadoc}/reactor/netty5/http/server/HttpServerRequest.html[`HttpServerRequest`].
The following example shows how to do so:

[source,java,indent=0]
.{examples-dir}/read/headers/Application.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/multipart/Application.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/multipart/custom/Application.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/clientaddress/Application.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/clientaddress/CustomForwardedHeaderHandlerApplication.java
[%unbreakable]
----
...
For more information, see {nettyjavadoc}/io.netty5.codec.http/io/netty5/handler/codec/http/HttpRequestDecoder.html[`HttpRequestDecoder`]
and {nettyjavadoc}/io.netty5.codec.http/io/netty5/handler/codec/http/HttpServerUpgradeHandler.html[`HttpServerUpgradeHandler`]

By default, the `HTTP` server is configured with the following settings:

[source,java,indent=0]
.{sourcedir}/reactor/netty5/http/HttpDecoderSpec.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty5/http/HttpDecoderSpec.java[lines=28..32]
----
[source,java,indent=0]
.{sourcedir}/reactor/netty5/http/server/HttpRequestDecoderSpec.java
[%unbreakable]
----
include::{sourcedir}/reactor/netty5/http/server/HttpRequestDecoderSpec.java[lines=40..45]
----

When you need to change these default settings, you can configure the `HTTP` server as follows:

[source,java,indent=0]
.{examples-dir}/requestdecoder/Application.java
[%unbreakable]
----
...
{nettyjavadoc}/io.netty5.codec/io/netty5/handler/codec/TooLongFrameException.html[TooLongFrameException]
is raised.
...
[source,java,indent=0]
.{examples-dir}/lifecycle/Application.java
[%unbreakable]
----
...
[source,java,indent=0]
.{examples-dir}/channeloptions/Application.java
[%unbreakable]
----
...
{nettyjavadoc}/io.netty5.handler/io/netty5/handler/ssl/SslProvider.html#OPENSSL[`SslProvider.OPENSSL`]
provider is used as a provider. Otherwise
{nettyjavadoc}/io.netty5.handler/io/netty5/handler/ssl/SslProvider.html#JDK[`SslProvider.JDK`] is used.
You can switch the provider by using
{nettyjavadoc}/io.netty5.handler/io/netty5/handler/ssl/SslContextBuilder.html#sslProvider(io.netty5.handler.ssl.SslProvider)[`SslContextBuilder`]
or by setting `-Dio.netty5.handler.ssl.noOpenSsl=true`.

The following example uses `SslContextBuilder`:

[source,java,indent=0]
.{examples-dir}/security/Application.java
----
...
[source,java,indent=0]
.{examples-dir}/sni/Application.java
----
...
You can use `-Dreactor.netty5.http.server.accessLogEnabled=true` to enable the `HTTP` access log by configuration.
...
<logger name="reactor.netty5.http.server.AccessLog" level="INFO" additivity="false">
...
[source,java,indent=0]
.{examples-dir}/accessLog/Application.java
----
...
[source,java,indent=0]
.{examples-dir}/accessLog/CustomLogAccessFormatApplication.java
----
...
[source,java,indent=0]
.{examples-dir}/accessLog/FilterLogAccessApplication.java
----
...
[source,java,indent=0]
.{examples-dir}/accessLog/CustomFormatAndFilterAccessLogApplication.java.java
----
...
[source,java,indent=0]
.{examples-dir}/http2/H2Application.java
----
include::{examples-dir}/http2/H2Application.java[lines=18..45]
----
...
[source,java,indent=0]
.{examples-dir}/http2/H2CApplication.java
----
...
[source,java,indent=0]
.{sourcedir}/reactor/netty5/http/HttpProtocol.java
----
include::{sourcedir}/reactor/netty5/http/HttpProtocol.java[lines=24..52]
----

[[metrics]]
== Metrics
The HTTP server supports built-in integration with https://micrometer.io/[`Micrometer`].
It exposes all metrics with a prefix of `reactor.netty5.http.server`.
...
| reactor.netty5.http.server.streams.active | Gauge | The number of active HTTP/2 streams.
See xref:observability.adoc#observability-metrics-streams-active[]
| reactor.netty5.http.server.connections.active | Gauge | The number of http connections currently processing requests.
See xref:observability.adoc#observability-metrics-connections-active[]
| reactor.netty5.http.server.connections.total | Gauge | The number of all opened connections.
See xref:observability.adoc#observability-metrics-connections-total[]
| reactor.netty5.http.server.data.received | DistributionSummary | Amount of the data received, in bytes.
See xref:observability.adoc#observability-metrics-data-received[]
| reactor.netty5.http.server.data.sent | DistributionSummary | Amount of the data sent, in bytes.
See xref:observability.adoc#observability-metrics-data-sent[]
| reactor.netty5.http.server.errors | Counter | Number of errors that occurred.
See xref:observability.adoc#observability-metrics-errors-count[]
| reactor.netty5.http.server.data.received.time | Timer | Time spent in consuming incoming data.
See xref:observability.adoc#observability-metrics-http-server-data-received-time[]
| reactor.netty5.http.server.data.sent.time | Timer | Time spent in sending outgoing data.
See xref:observability.adoc#observability-metrics-http-server-data-sent-time[]
| reactor.netty5.http.server.response.time | Timer | Total time for the request/response
See xref:observability.adoc#observability-metrics-http-server-response-time[]
|=======
...
[source,java,indent=0]
.{examples-dir}/metrics/Application.java
----
...
[source,java,indent=0]
.{examples-dir}/metrics/custom/Application.java
----
...
See xref:observability.adoc#observability-spans-http-server-response-span[].
|=======
...
[source,java,indent=0]
.{examples-dir}/tracing/Application.java
----
...
[source,java,indent=0]
.{examples-dir}/tracing/custom/Application.java
----
...
[source,java,indent=0]
.{examples-dir}/uds/Application.java
----
...
[source,java,indent=0]
.{examples-dir}/read/timeout/Application.java
----
...
[source,java,indent=0]
.{examples-dir}/idle/timeout/Application.java
----
...
[source,java,indent=0]
.{examples-dir}/security/custom/Application.java
----
