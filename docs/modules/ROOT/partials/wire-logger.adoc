...
[%unbreakable]
----
include::{examples-dir}/wiretap/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{formattersourcedir}/reactor/netty/transport/logging/AdvancedByteBufFormat.java[tags=snippet-code-2]
----
...
[%unbreakable]
----
include::{formattersourcedir}/reactor/netty/transport/logging/AdvancedByteBufFormat.java[tags=snippet-code-1]
----
...
[%unbreakable]
----
include::{formattersourcedir}/reactor/netty/transport/logging/AdvancedByteBufFormat.java[tags=snippet-code-3]
----
...
[%unbreakable]
----
include::{examples-dir}/wiretap/custom/Application.java[tags=snippet-application]
----
<1> Enables the wire logging,
