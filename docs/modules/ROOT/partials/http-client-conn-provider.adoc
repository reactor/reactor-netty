...
[%unbreakable]
----
include::{core}/src/main/java/reactor/netty/ReactorNetty.java[tags=snippet-code-3]
----
...
[%unbreakable]
----
include::{examples-dir}/pool/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/http2/pool/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/http2/pool/StrictReuseApplication.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/pool/metrics/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/pool/metrics/http/Application.java[tags=snippet-application]
----
...
[%unbreakable]
----
include::{examples-dir}/pool/metrics/http2/Application.java[tags=snippet-application]
----
