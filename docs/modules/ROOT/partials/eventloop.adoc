...
[%unbreakable]
----
include::{eventloopsourcedir}/reactor/netty/ReactorNetty.java[tags=snippet-code-1]
----
...
[%unbreakable]
----
include::{examples-dir}/eventloop/Application.java[tags=snippet-application]
----
