...
sources at https://github.com/reactor/reactor-netty/tree/netty5/docs/asciidoc.
...
link:https://github.com/reactor/reactor-netty/edit/netty5/docs/asciidoc/about-doc.adoc[Suggest Edit^, role="fa fa-edit"] to <<about-doc>>.
endif::[]
