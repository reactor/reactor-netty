:sourcedir: ./../../reactor-netty5-core/src/main/java
:examplesdir: ./../../reactor-netty5-examples/src/main/java/reactor/netty5/examples/documentation/tcp/client
...
----
include::{sourcedir}/reactor/netty5/ReactorNetty.java[lines=89..118]
----
====
