...
:examplesdir: ./../../reactor-netty5-examples/src/main/java/reactor/netty5/examples/documentation/http/server
...
----
include::{examplesdir}/http2/H2Application.java[lines=18..45]
----
