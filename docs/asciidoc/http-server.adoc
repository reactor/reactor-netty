...
| reactor.netty.http.server.connections.active | Counter | The number of http connections currently processing requests
| reactor.netty.http.server.connections.total | Counter | The number of all opened connections
