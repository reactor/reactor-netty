...
<2> As of this writing, `2020.0.9` is the latest version of the `BOM`.
...
dependencies {
    // import a BOM
    implementation platform('io.projectreactor:reactor-bom:2020.0.9') <1>
...
----
<1> As of this writing, `2020.0.9` is the latest version of the `BOM`.
Check for updates at https://github.com/reactor/reactor/releases.
