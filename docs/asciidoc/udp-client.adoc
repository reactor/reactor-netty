...
:examplesdir: ./../../reactor-netty5-examples/src/main/java/reactor/netty5/examples/documentation/udp/client
...
----
include::{sourcedir}/reactor/netty5/ReactorNetty.java[lines=84..114]
----
====
