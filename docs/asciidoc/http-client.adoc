...
:examplesdir: ./../../reactor-netty5-examples/src/main/java/reactor/netty/examples/documentation/http/client
...
----
include::{sourcedir}/reactor/netty/http/HttpDecoderSpec.java[lines=29..38]
----
====
====
[source,java,indent=0]
