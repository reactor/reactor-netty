 ...
 * <p>
 * Can be used in {@link reactor.netty5.http.server.HttpServer#errorLog(boolean, ErrorLogFactory) errorLog} method for example.
 *
 * @author raccoonback
 * @since 1.2.6
 */
public interface ErrorLogFactory extends Function<ErrorLogArgProvider, @Nullable ErrorLog> {
	 ...
	 * {@link reactor.netty5.http.server.HttpServer#errorLog(boolean, ErrorLogFactory)}
	 */
