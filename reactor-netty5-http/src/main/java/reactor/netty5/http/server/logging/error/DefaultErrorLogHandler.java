...
public final class DefaultErrorLogHandler extends BaseErrorLogHandler {
	...
	public DefaultErrorLogHandler(@Nullable Function<ErrorLogArgProvider, @Nullable ErrorLog> errorLog) {
		super(errorLog);
	}

	@Override
	public void channelExceptionCaught(io.netty5.channel.ChannelHandlerContext ctx, Throwable cause) {
		ErrorLog log;
	...
	public void channelInboundEvent(ChannelHandlerContext ctx, Object evt) {
		if (evt instanceof DefaultErrorLogEvent) {
			channelExceptionCaught(ctx, ((DefaultErrorLogEvent) evt).cause());
		}
