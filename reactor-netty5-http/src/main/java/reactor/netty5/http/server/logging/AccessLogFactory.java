 ...
 * <p>
 * Can be used in {@link reactor.netty5.http.server.HttpServer#accessLog(boolean, AccessLogFactory) accessLog} method for example.
 *
 * @author Simon Baslé
 * @author Audrey Neveu
 * @since 1.0.3
...
public interface AccessLogFactory extends Function<AccessLogArgProvider, AccessLog> {
	 ...
	 * {@link reactor.netty5.http.server.HttpServer#accessLog(boolean, AccessLogFactory)}
	 * @since 1.0.3
	 */
