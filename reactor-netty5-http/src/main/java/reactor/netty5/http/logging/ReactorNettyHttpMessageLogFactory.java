...
import static reactor.netty5.http.logging.HttpMessageLogUtils.logHttpMessage;
...
public class ReactorNettyHttpMessageLogFactory extends AbstractHttpMessageLogFactory {
	...
	static final Function<Map.Entry<CharSequence, CharSequence>, String> DEFAULT_HEADER_VALUE_FUNCTION = e -> "<filtered>";
