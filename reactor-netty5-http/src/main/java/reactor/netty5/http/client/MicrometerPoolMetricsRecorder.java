...
import static reactor.netty5.http.client.Http2ConnectionProviderMeters.PENDING_STREAMS_TIME;
import static reactor.netty5.http.client.Http2ConnectionProviderMeters.PendingStreamsTimeTags.ID;
import static reactor.netty5.http.client.Http2ConnectionProviderMeters.PendingStreamsTimeTags.NAME;
import static reactor.netty5.http.client.Http2ConnectionProviderMeters.PendingStreamsTimeTags.REMOTE_ADDRESS;
import static reactor.netty5.http.client.Http2ConnectionProviderMeters.PendingStreamsTimeTags.STATUS;
