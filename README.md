...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.2.9-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.2.8"
      //compile "io.projectreactor.netty:reactor-netty-http:1.2.9-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.2.8"
    }
```
