...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.1.13-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.1.12"
      //compile "io.projectreactor.netty:reactor-netty-http:1.1.13-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.1.12"
    }
```
