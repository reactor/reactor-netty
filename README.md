...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.0.22-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.0.21"
      //compile "io.projectreactor.netty:reactor-netty-http:1.0.22-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.0.21"
    }
```
