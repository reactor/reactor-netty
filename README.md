...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.2.8-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.2.7"
      //compile "io.projectreactor.netty:reactor-netty-http:1.2.8-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.2.7"
    }
```
