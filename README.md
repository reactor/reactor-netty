...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.0.43-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.0.42"
      //compile "io.projectreactor.netty:reactor-netty-http:1.0.43-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.0.42"
    }
```
