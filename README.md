...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.0.9-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.0.8"
      //compile "io.projectreactor.netty:reactor-netty-http:1.0.9-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.0.8"
    }
```
