...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.0.33-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.0.32"
      //compile "io.projectreactor.netty:reactor-netty-http:1.0.33-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.0.32"
    }
```
