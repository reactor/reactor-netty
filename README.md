...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.3.6-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.3.5"
      //compile "io.projectreactor.netty:reactor-netty-http:1.3.6-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.3.5"
    }
```
