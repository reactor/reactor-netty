...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.2.16-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.2.15"
      //compile "io.projectreactor.netty:reactor-netty-http:1.2.16-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.2.15"
    }
```
