...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.1.30-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.1.29"
      //compile "io.projectreactor.netty:reactor-netty-http:1.1.30-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.1.29"
    }
```
