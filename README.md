...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.2.12-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.2.11"
      //compile "io.projectreactor.netty:reactor-netty-http:1.2.12-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.2.11"
    }
```
