...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.1.10-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.1.9"
      //compile "io.projectreactor.netty:reactor-netty-http:1.1.10-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.1.9"
    }
```
