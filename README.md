...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.2.14-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.2.13"
      //compile "io.projectreactor.netty:reactor-netty-http:1.2.14-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.2.13"
    }
```
