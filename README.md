...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.3.5-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.3.4"
      //compile "io.projectreactor.netty:reactor-netty-http:1.3.5-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.3.4"
    }
```
