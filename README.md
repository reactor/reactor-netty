...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.2.18-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.2.17"
      //compile "io.projectreactor.netty:reactor-netty-http:1.2.18-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.2.17"
    }
```
