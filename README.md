...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.0.29-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.0.28"
      //compile "io.projectreactor.netty:reactor-netty-http:1.0.29-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.0.28"
    }
```
