...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.0.47-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.0.46"
      //compile "io.projectreactor.netty:reactor-netty-http:1.0.47-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.0.46"
    }
```
