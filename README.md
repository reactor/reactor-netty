...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.1.32-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.1.31"
      //compile "io.projectreactor.netty:reactor-netty-http:1.1.32-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.1.31"
    }
```
