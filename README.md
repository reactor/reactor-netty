...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.1.3-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.1.2"
      //compile "io.projectreactor.netty:reactor-netty-http:1.1.3-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.1.2"
    }
```
