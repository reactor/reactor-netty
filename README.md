...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.2.4-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.2.3"
      //compile "io.projectreactor.netty:reactor-netty-http:1.2.4-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.2.3"
    }
```
