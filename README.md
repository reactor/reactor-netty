...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.3.3-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.3.2"
      //compile "io.projectreactor.netty:reactor-netty-http:1.3.3-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.3.2"
    }
```
