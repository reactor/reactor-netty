...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.0.49-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.0.48"
      //compile "io.projectreactor.netty:reactor-netty-http:1.0.49-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.0.48"
    }
```
