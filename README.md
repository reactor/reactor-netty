...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.1.22-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.1.21"
      //compile "io.projectreactor.netty:reactor-netty-http:1.1.22-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.1.21"
    }
```
