...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.1.9-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.1.8"
      //compile "io.projectreactor.netty:reactor-netty-http:1.1.9-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.1.8"
    }
```
