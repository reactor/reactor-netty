...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.2.11-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.2.10"
      //compile "io.projectreactor.netty:reactor-netty-http:1.2.11-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.2.10"
    }
```
