...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.0.26-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.0.25"
      //compile "io.projectreactor.netty:reactor-netty-http:1.0.26-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.0.25"
    }
```
