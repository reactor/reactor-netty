...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.1.17-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.1.16"
      //compile "io.projectreactor.netty:reactor-netty-http:1.1.17-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.1.16"
    }
```
