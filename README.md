...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.0.30-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.0.29"
      //compile "io.projectreactor.netty:reactor-netty-http:1.0.30-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.0.29"
    }
```
