...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty:reactor-netty-core:1.3.8-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-core:1.3.7"
      //compile "io.projectreactor.netty:reactor-netty-http:1.3.8-SNAPSHOT"
      compile "io.projectreactor.netty:reactor-netty-http:1.3.7-M1"
    }
```
