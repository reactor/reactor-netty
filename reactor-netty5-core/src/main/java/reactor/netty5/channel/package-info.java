 ...
 * <p>
 * {@link reactor.netty5.channel.ChannelOperations} will be exposed as the user edge API
 * and extended by various protocols such as HTTP. It will convert incoming read into
 * {@link reactor.netty5.NettyInbound#receive()} and apply read backpressure.
 * <p>
 * {@link reactor.netty5.channel.ChannelOperationsHandler} will tail the
