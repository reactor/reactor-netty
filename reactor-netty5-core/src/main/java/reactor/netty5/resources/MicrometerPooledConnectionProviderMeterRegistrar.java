...
import static reactor.netty5.resources.ConnectionProviderMeters.ACTIVE_CONNECTIONS;
import static reactor.netty5.resources.ConnectionProviderMeters.ConnectionProviderMetersTags.ID;
import static reactor.netty5.resources.ConnectionProviderMeters.ConnectionProviderMetersTags.NAME;
import static reactor.netty5.resources.ConnectionProviderMeters.ConnectionProviderMetersTags.REMOTE_ADDRESS;
import static reactor.netty5.resources.ConnectionProviderMeters.IDLE_CONNECTIONS;
import static reactor.netty5.resources.ConnectionProviderMeters.MAX_CONNECTIONS;
import static reactor.netty5.resources.ConnectionProviderMeters.MAX_PENDING_CONNECTIONS;
import static reactor.netty5.resources.ConnectionProviderMeters.PENDING_CONNECTIONS;
import static reactor.netty5.resources.ConnectionProviderMeters.TOTAL_CONNECTIONS;

/**
 * Default implementation of {@link reactor.netty5.resources.ConnectionProvider.MeterRegistrar}.
 *
