...
enum ConnectionProviderMeters implements MeterDocumentation {
	...
	MAX_CONNECTIONS {
		@Override
		public String getName() {
			return "reactor.netty5.connection.provider.max.connections";
		}
	...
	MAX_PENDING_CONNECTIONS {
		@Override
		public String getName() {
			return "reactor.netty5.connection.provider.max.pending.connections";
		}
	...
	PENDING_CONNECTIONS {
		@Override
		public String getName() {
			return "reactor.netty5.connection.provider.pending.connections";
		}
	...
	PENDING_CONNECTIONS_TIME {
		@Override
		public String getName() {
			return "reactor.netty5.connection.provider.pending.connections.time";
		}
	...
	TOTAL_CONNECTIONS {
		@Override
		public String getName() {
			return "reactor.netty5.connection.provider.total.connections";
		}
