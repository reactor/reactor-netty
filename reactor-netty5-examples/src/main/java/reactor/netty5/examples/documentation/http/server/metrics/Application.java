 ...
 */
package reactor.netty5.examples.documentation.http.server.metrics;
...
public class Application {
	...
	public static void main(String[] args) {
		Metrics.globalRegistry //<1>
		       .config()
		       .meterFilter(MeterFilter.maximumAllowableTags("reactor.netty5.http.server", "URI", 100, MeterFilter.deny()));
