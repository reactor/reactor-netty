...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty.incubator:reactor-netty-incubator-quic:0.1.12-SNAPSHOT"
      compile "io.projectreactor.netty.incubator:reactor-netty-incubator-quic:0.1.11"
    }
```
