...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty.incubator:reactor-netty-incubator-quic:0.0.24-SNAPSHOT"
      compile "io.projectreactor.netty.incubator:reactor-netty-incubator-quic:0.0.23"
    }
```
