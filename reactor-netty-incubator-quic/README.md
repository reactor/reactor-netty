...
```groovy
    ...
    dependencies {
      //compile "io.projectreactor.netty.incubator:reactor-netty-incubator-quic:0.2.9-SNAPSHOT"
      compile "io.projectreactor.netty.incubator:reactor-netty-incubator-quic:0.2.8"
    }
```
