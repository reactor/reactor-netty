...
class HttpClientOperationsTest extends BaseHttpTest {
	...
	void testConstructorWithProvidedReplacement_2(HttpProtocol[] serverProtocols, HttpProtocol[] clientProtocols,
		...
		try {
			...
			AtomicReference<HttpClientRequest> request = new AtomicReference<>();
			AtomicReference<Channel> requestChannel = new AtomicReference<>();
			AtomicReference<Channel> responseChannel = new AtomicReference<>();
			AtomicReference<ConnectionObserver> requestListener = new AtomicReference<>();
			AtomicReference<ConnectionObserver> responseListener = new AtomicReference<>();
	...
	void testConstructorWithProvidedReplacement_3(HttpProtocol[] serverProtocols, HttpProtocol[] clientProtocols,
		...
		try {
			...
			AtomicReference<HttpClientRequest> request = new AtomicReference<>();
			AtomicReference<HttpClientResponse> response = new AtomicReference<>();
			AtomicReference<Channel> requestChannel = new AtomicReference<>();
			AtomicReference<Channel> responseChannel = new AtomicReference<>();
			AtomicReference<ConnectionObserver> requestListener = new AtomicReference<>();
			AtomicReference<ConnectionObserver> responseListener = new AtomicReference<>();
	...
	private static String followRedirect(HttpClient originalClient, AtomicReference<HttpClientRequest> request,
			AtomicReference<HttpClientResponse> response, AtomicReference<Channel> requestChannel,
			AtomicReference<Channel> responseChannel, AtomicReference<ConnectionObserver> requestListener,
			AtomicReference<ConnectionObserver> responseListener, @Nullable Consumer<HttpClientRequest> redirectRequestConsumer,
	...
	private static String followRedirect(HttpClient originalClient, AtomicReference<HttpClientRequest> request,
			AtomicReference<HttpClientResponse> response, AtomicReference<Channel> requestChannel,
			AtomicReference<Channel> responseChannel, AtomicReference<ConnectionObserver> requestListener,
			AtomicReference<ConnectionObserver> responseListener, BiPredicate<HttpClientRequest, HttpClientResponse> predicate,
