...
class UriEndpointFactoryTest {
	...
	void shouldParseUrls_1() {
		List<@Nullable String[]> inputs = Arrays.asList(
				...
				new @Nullable String[]{"http://localhost/path", "http", "localhost", null, "/path"},
				new @Nullable String[]{"http://localhost/path?key=val", "http", "localhost", null, "/path?key=val"},
				new @Nullable String[]{"http://localhost/", "http", "localhost", null, "/"},
				new @Nullable String[]{"http://localhost/?key=val", "http", "localhost", null, "/?key=val"},
				new @Nullable String[]{"http://localhost", "http", "localhost", null, null},
				new @Nullable String[]{"http://localhost?key=val", "http", "localhost", null, "?key=val"},
				new @Nullable String[]{"http://localhost:80", "http", "localhost", "80", null},
				new String[]{"http://localhost:80?key=val", "http", "localhost", "80", "?key=val"},
				new @Nullable String[]{"http://localhost/:1234", "http", "localhost", null, "/:1234"},
				new String[]{"http://[::1]:80/path", "http", "[::1]", "80", "/path"},
				new String[]{"http://[::1]:80/path?key=val", "http", "[::1]", "80", "/path?key=val"},
				new @Nullable String[]{"http://[::1]/path", "http", "[::1]", null, "/path"},
				new @Nullable String[]{"http://[::1]/path?key=val", "http", "[::1]", null, "/path?key=val"},
				new @Nullable String[]{"http://[::1]/", "http", "[::1]", null, "/"},
				new @Nullable String[]{"http://[::1]/?key=val", "http", "[::1]", null, "/?key=val"},
				new @Nullable String[]{"http://[::1]", "http", "[::1]", null, null},
				new @Nullable String[]{"http://[::1]?key=val", "http", "[::1]", null, "?key=val"},
				new @Nullable String[]{"http://[::1]:80", "http", "[::1]", "80", null},
				new String[]{"http://[::1]:80?key=val", "http", "[::1]", "80", "?key=val"},
				new @Nullable String[]{"localhost:80/path", null, "localhost", "80", "/path"},
				new @Nullable String[]{"localhost:80/path?key=val", null, "localhost", "80", "/path?key=val"},
				new @Nullable String[]{"localhost/path", null, "localhost", null, "/path"},
				new @Nullable String[]{"localhost/path?key=val", null, "localhost", null, "/path?key=val"},
				new @Nullable String[]{"localhost/", null, "localhost", null, "/"},
				new @Nullable String[]{"localhost/?key=val", null, "localhost", null, "/?key=val"},
				new @Nullable String[]{"localhost", null, "localhost", null, null},
				new @Nullable String[]{"localhost?key=val", null, "localhost", null, "?key=val"},
