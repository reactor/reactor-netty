...
public class HttpClientMetricsTracingRecordingHandlerSpanCustomizer implements TracingRecordingHandlerSpanCustomizer<Timer.HandlerContext> {

	@Override
	public boolean supportsContext(Timer.HandlerContext handlerContext) {
		return handlerContext instanceof MicrometerHttpClientMetricsHandler.WriteHandlerContext || handlerContext instanceof MicrometerHttpClientMetricsHandler.ReadHandlerContext;
	}
