...
public final class HttpServerConfig extends ServerTransportConfig<HttpServerConfig> {
	...
	static void addStreamHandlers(Channel ch,
		...
		if (Boolean.TRUE.equals(connectProtocolEnabled)) {
			pipeline.addLast(H2ProtocolHeaderHandler.NAME, H2ProtocolHeaderHandler.INSTANCE);
		}
	...
	static final class H2ProtocolHeaderHandler extends ChannelInboundHandlerAdapter {

		static final H2ProtocolHeaderHandler INSTANCE = new H2ProtocolHeaderHandler();
		static final String NAME = LEFT + "h2ProtocolHeaderHandler";
